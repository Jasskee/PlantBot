...
public class HelpCommand implements Command{
    ...
    public static final String HELP_MESSAGE = String.format("✨<b>Доступные команды</b>✨\n\n"
                    ...
                    + "%s - Полив растений\n\n"
                    + "%s - Удобрение растений\n\n"
                    + "%s - Пересадка растений\n\n"
                    + "%s - получить помощь в работе со мной\n",
            START.getCommandName(), STOP.getCommandName(), WATER.getCommandName(), FERTILIZER.getCommandName(),
            SWAP.getCommandName(), HELP.getCommandName());
